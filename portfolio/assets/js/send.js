function initateEnvelop() {
  ...
  canvas.click(function() {
    if(mail.value != "" && object.value != "" && subject.value != "" && validateEmail(mail.value))
    { 
      animate();
      canvas.unclick();
    }
    ...
    {
      alert("You must fill in all 3 fields and have a valid address")
    }
  });
};